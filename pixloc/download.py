...
def download_from_google_drive(id: str, 
                               save_path: Path,
...
def download_7Scenes(do_dataset=True, do_outputs=True):
    ...
    if do_dataset:
        ...
        download_from_google_drive('1cu6KUR7WHO7G4EO49Qi3HEKU6n_yYDjb', out_path / zipfile)
...
def download_Cambridge(do_dataset=True, do_outputs=True):
    ...
    if do_dataset:
        ...
        download_from_google_drive('1esqzZ1zEQlzZVic-H32V6kkZvc4NeS15', out_path / zipfile)
...
def download_CMU(do_dataset=True, 
                 do_outputs=True, 
                 do_training=True,
...
def download_MegaDepth(do_training=True):
    logger.info(
        ...
        'https://github.com/mihaidusmanu/d2-net#downloading-and-preprocessing-the-megadepth-dataset'
    )  # noqa
...
if __name__ == '__main__':
    ...
    parser.add_argument('--select', default=choices, choices=choices, nargs='+', help='Data to download, default: all.')
    parser.add_argument('--CMU_slices', choices=TEST_SLICES_CMU+TRAINING_SLICES_CMU, nargs='+', type=int, help='CMU slices to download, default: all.')
    parser.add_argument('--training', action='store_true', help='Whether to download training data and dumps, default: false.')
